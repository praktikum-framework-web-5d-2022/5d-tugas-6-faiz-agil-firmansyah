            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo e(route('konsumen.store')); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama" placeholder="Masukkan Nama Konsumen" class="form-control" value="<?php echo e(old('nama')); ?>">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\src\tugas6\resources\views/konsumen/create.blade.php ENDPATH**/ ?>